...
DayAheadprices = pd.read_excel("smard/Day-ahead_prices_201901010000_201912312359.xlsx", sheet_name="Day-ahead prices", usecols="C:D", engine='openpyxl', parse_dates=["Datetime"])
...
# ElectricityPrices 
ElectrcityPricesbyGeneration = ElectrcityMarginalCosts/TotalGeneration
...
plt.plot(DayAheadprices.Prices)
plt.plot(DayAheadprices.index.values, ElectrcityPricesbyGeneration)

plt.title('Electricity prices') 
plt.ylabel('Eur/MWh') 
plt.show()

# Elecprices = ElectrcityPrices.values
# Elecprices.sort()
# ElectrcityPrices.values.sort()
# plt.plot(Elecprices)
# plt.title('Electricity prices') 
# plt.ylabel('Eur/MWh') 
# plt.show()
...
# plt.legend(["2016 Load", '2016 residual load', "3 times RE generation"])
# plt.show()
